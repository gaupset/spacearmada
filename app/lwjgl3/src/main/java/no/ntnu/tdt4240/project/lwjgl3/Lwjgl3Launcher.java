package no.ntnu.tdt4240.project.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;

import no.ntnu.tdt4240.project.AppProperties;
import no.ntnu.tdt4240.project.Main;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle(AppProperties.TITLE);
        ...
        configuration.setWindowedMode(AppProperties.WIDTH, AppProperties.HEIGHT);
